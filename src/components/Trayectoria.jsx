...
import PlantaCreciendo from "./PlantaCreciendo";
...
function Hoja() {
  return (
    ...
    >
      <path
        d="M4 20 C6 11, 12 5, 20 4 C19 12, 13 19, 4 20 Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    <section id="trayectoria" className="seccion">
      <div className="envoltura">
        ...
        <div className="trayectoria-rejilla">
          <div>
                ...
                <li key={puesto.empresa} className="trayectoria-fila">
                  ...
                  <div className="trayectoria-cuerpo">
                    <p className="trayectoria-periodo">
                      {puesto.periodo}
                      {indice === 0 && (
                        <span className="trayectoria-actual">
                          {t.trayectoria.actual}
                        </span>
                      )}
                    </p>
          ...
          <div className="trayectoria-jardin">
            <PlantaCreciendo />
          </div>
        </div>

        <h3 className="trayectoria-formacion-titulo">
          {t.trayectoria.formacionTitulo}
        </h3>
