...
const objetivos = [
  ...
  },
  {
    ...
    tomas: [
      { nombre: 'zolarium', ruta: '/', desplazamiento: 0 },
  ...
  },
  {
    ...
    tomas: [
      { nombre: 'copilot', ruta: '/', desplazamiento: 0 },
  ...
  },
  {
    ...
    tomas: [
      { nombre: 'travel', ruta: '/', desplazamiento: 0 },
      { nombre: 'travel-1', ruta: '/', desplazamiento: 800 },
      { nombre: 'travel-2', ruta: '/', desplazamiento: 1600 },
      { nombre: 'travel-3', ruta: '/', desplazamiento: 2400 }
    ]
  }
]
...
async function capturar(navegador, objetivo) {
  ...
  for (const toma of objetivo.tomas) {
    ...
    await pagina.screenshot({ path: archivo, type: 'jpeg', quality: 84 })
    console.log(`  ${archivo}`)
  }
